...
import type { Alert, Assessment, Event, Firms, RecordRef, Region, Tail, Track, Viewport } from "../lib/types";
...
export function OperationalMap({ events, tracks, alerts, firms, tails, regions, layers, viewport, assessments = [], filterAoi, drawing, focus, satelliteDay, replayBounds, compareSelection = [], compareVerdict, compareArticleMatch, onDraft, onSelect, onAoiZoom, onBackgroundClick, onViewport, onLayerToggle }: Props) {
