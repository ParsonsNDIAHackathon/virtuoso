...
export function App() {
  ...
  const shownGdelt = visibleEvents.filter((event) => !event.id.startsWith("tg:")).length;
  const shownTelegram = visibleEvents.filter((event) => event.id.startsWith("tg:")).length;
