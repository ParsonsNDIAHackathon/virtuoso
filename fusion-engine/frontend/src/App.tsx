...
export function App() {
  ...
  const [layers, setLayers] = useState<LayerState>({ events: true, tracks: true, firms: true, links: true, imagery: false, rf: true, ais: true, sar: false }); const [timelineHours, setTimelineHours] = useState(24); const [sourcesOpen, setSourcesOpen] = useState(false);
