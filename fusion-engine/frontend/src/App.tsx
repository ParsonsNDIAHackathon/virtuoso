...
export function App() {
  ...
  const zoomToRegion = useCallback((region: Region) => setFocus([region.lat, region.lon, Math.max(3, Math.min(11, Math.round(Math.log2(20000 / (region.radius_nm * 1.852)))))]), []);
